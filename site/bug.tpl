<div class="container-fluid">
	...
	<form class="form-horizontal" role="form" action="bug.php">
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="subject" placeholder="A brief outline">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-sm-2" for="body">Body:</label>
			<div class="col-sm-10"> 
				<textarea rows="4" cols="50" class="form-control" id="body" placeholder="A detailed description">
				</textarea>
			</div>
		</div>
		<div class="form-group"> 
