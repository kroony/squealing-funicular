create user 'kr00ny_sfUser'@'localhost' IDENTIFIED BY '}8FCULdmEgqo'
GRANT ALL PRIVILEGES ON kr00ny_sf.* To 'kr00ny_sfUser'@'localhost' IDENTIFIED BY '}8FCULdmEgqo';


create database kr00ny_sf;
use kr00ny_sf;
